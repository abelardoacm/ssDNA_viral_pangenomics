...
#
# Using "split" scripts (those that split and reformat anytaxon.gb)
#
...
rm rename_rules.txt # Cleans temporary files
rm $1.gb # Cleans temporary files
